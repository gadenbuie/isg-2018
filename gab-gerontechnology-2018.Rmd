...
duo_accent(
  ...
  extra_css = list(
    ...
    ".remark-slide-content.title-slide" = list(
      "background-image" = "url(images/usf-v-greengold.jpg)",
...
- Use permutations to<br>**explain differences**
]

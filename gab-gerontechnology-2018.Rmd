...
- As a typical retiree living in the Sunshine State, she leads a highly active 
  life involving an assortment of clubs and groups, dance classes at the 
  recreation center, and frequent lunches and dinners in the town square with friends.
- She lives alone, but she talks to her daughter regularly, even though she lives
...
- She arrived at the hospital the day of the procedure only to find out that due 
  to an insurance issue meant, she would have to wait another three months.
- In the mean time, her mobility declined, she spent more time in bed, and she 
  couldn't make it many of the activities she loved.
...
Fortunately, throughout this story, Dorothy's daughter was able to stay in 
touch with her mother's daily activities thanks to the home sensor system
we installed in Dorothy's home.

We call this system **HomeSense**, and
- the goal the system and our study is to better monitor the daily activities of older adults
...
- Americans 65+ will **double** from 2014 to **98M** in 2060

- Decrease in available traditional family caregivers

- 2/3 manage multiple chronic conditions

- Strong preference to<br>**age in place**<sup>`r add_ref("Mather2015")`</sup>
]
...
.footnote.small[`r refs["Mather2015"]`: Mather et al. (2015).<br>Aging in the United States. [pbr.org](http://www.pbr.org/)]

???

Dorothy's story highlights the challenges we face as a society in how we approach
aging and manage health care for older adults.

1. Part of a growing population of older adults that is expected to double to 98M by 2060 (from 2014 population)

2. More older adults are divorced, live alone than ever before, meaning weaker ties to traditional family caregivers, either by distance or relationship

3. Simultaneously, managing chronic illness rather than acute episodes

4. But overall strong preference to age in place, remain in their own homes and communities, for as long as possible **TODO: stat and reference from proposal**
...
Collaborative for Research & Ed in Aging, Tech & Health

Community Partners, Funders, Academics, Students from a variety of disciplines – supported and connected by our university --  all focused on improving health and qol of life in late life
...
detection of changes in routine?<br>
]
...
- Alleviate burden of chronic illness with supportive technology
...
- Permutation-based methods for change detection<sup>`r add_ref("Sprint2016")`</sup>

- Alert caregivers or system operators to shifts in behavior patterns

.footnote[
`r refs["Sprint2016"]`: Sprint, Cook & Schmitter-Edgecombe, 2016
]
...
- Use permutations to<br>**explain differences**<sup>`r add_ref("Tulio2016")`</sup>
]
...
.footnote[
`r refs["Tulio2016"]`: Tulio 2016. arXiv:1602.04938
]
